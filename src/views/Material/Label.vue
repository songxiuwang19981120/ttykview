<template>
	<div>
		...
		<!-- 上传弹层 -->
		<LabelUploadDialog :showDialog.sync="showUploadDialog" :upParameter="parameterData" :nnClassifyDate="tableData">
		</LabelUploadDialog>
	</div>
</template>
...
import LabelUploadDialog from './component/LabelUploadDialog.vue';
