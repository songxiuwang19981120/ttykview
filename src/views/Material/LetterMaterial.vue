<template>
	<div>
			...
			<div class="tt-accsituation--operation">
				<div>
					<el-select v-model="searchTableData.equipment" placeholder="账号分组选择" style="margin-right: 20px"
						@change="searchEquipmentChange" clearable size="medium">
		...
		<!-- 详情弹层 -->
		<LetterMaterialDetailDialog :outerVisible.sync="showDetailDialog" ref="detailDialog" :upParameter="nickData">
		</LetterMaterialDetailDialog>
		<!-- 上传弹层 -->
		<LetterMaterialUploadDialog :showDialog.sync="showUploadDialog" :upParameter="parameterData"
			:nnClassifyDate="tableData"></LetterMaterialUploadDialog>
	</div>
</template>
...
import LetterMaterialUploadDialog from './component/LetterMaterialUploadDialog';
export default {
