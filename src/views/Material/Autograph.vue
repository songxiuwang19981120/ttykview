<template>
	<div>
		...
		<!-- 详情弹层 -->
		<AutographDetailDialog :outerVisible.sync="showDetailDialog" ref="detailDialog" :upParameter="nickData">
		</AutographDetailDialog>
		<!-- 上传弹层 -->
		<AutographUploadDialog :showDialog.sync="showUploadDialog" :upParameter="parameterData"
			:nnClassifyDate="tableData"></AutographUploadDialog>
	</div>
</template>
...
import AutographUploadDialog from './component/AutographUploadDialog.vue';
...
export default {
	...
	created() {
		this.getaccGroup();
		this.getAutographClassify(this.page);
	},
