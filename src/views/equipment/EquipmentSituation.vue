<template>
    <div class="tt-equisituation">
        <div class="tt-equisituation-search">
            ...
            <div style="float:left">
                ...
                <el-drawer title="修改分组" :before-close="handleClose" :visible.sync="dialog" direction="rtl"
                    ...
                    <div class="">
                        ...
                        <!-- 更改显示状态的列表 -->
                        <table-custom   :loading="loading" :tableData="tableData2"
                :columns="columns2"></table-custom>
            ...
            <div style="float:left;">
                ...
                <el-dialog title="创建账号" style="width:50%; margin:0 auto" :visible.sync="dialogFormVisible" :before-close="handleCloseDialog" >
                    <!-- 四级联动 -->
                    ...
                    <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
                        ...
                        <el-form-item label="最大容量:" label-width="100px">
                            <!-- 计数器 -->
                            <el-input-number v-model="ruleForm.num" @change="handleChangeNum" :min="1" :max="10" label="请输入单设备最大容量"></el-input-number>  
                        </el-form-item>
                    </el-form>
...
<style lang="stylus">
.tt-equisituationSibmit
   position:absolute
   right: 10px
   bottom: 10px
.tt-equisituation-search
