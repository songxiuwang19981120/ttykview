    ...
    <div class="EquipmentSituation">
      <div class="tt-accsituation">
        <div class="tt-accsituation--operation">
          ...
          <el-button type="primary" size="medium" @click="examine_index">查看</el-button>
          <el-button type="primary" size="medium" @click="reset">重置</el-button>
          <el-button type="primary" size="medium" @click="dialog = true">修改分组</el-button>
          <el-button style="margin-right: 20px;" type="primary" size="medium"
            @click="dialogFormVisible = true">创建账号</el-button>
        </div>
