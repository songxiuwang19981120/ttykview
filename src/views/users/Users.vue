	...
	<div>
		<div class="tt-accsituation">
			<div class="tt-accsituation--operation">
				<el-input size="medium" v-model="searchTableData.user" placeholder="请填写用户名"
					style="width: 130px; margin-right: 20px"></el-input>
				<el-input size="medium" v-model="searchTableData.name" placeholder="请填写真实姓名"
					style="width: 130px; margin-right: 20px"></el-input>
				<el-input size="medium" v-model="searchTableData.phone" placeholder="请填写联系电话"
					style="width: 150px; margin-right: 20px"></el-input>
				<el-select v-model="searchTableData.role_id" placeholder="请选择角色"
					style="width: 140px; margin-right: 20px" size="medium">
		...
		<!-- 编辑用户弹层 -->
		<editUser :showdialog.sync="showEditDialog" ref="edituser"></editUser>
		<!-- 重置密码弹层 -->
