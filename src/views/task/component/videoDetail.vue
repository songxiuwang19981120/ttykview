<template>
	<el-dialog width="70%" title="视频任务详情" :visible="showdialog" @close="btnCancel">
		<table-custom :loading="loading" :tableData="tableData" :columns="columns" :height="tableHeight" @handleSelectionChange="handleSelectionChange">
		</table-custom>
		...
		<el-dialog width="60%" title="日志详情" :visible.sync="innerVisible" append-to-body  @close="btnInnerCancel">
			<table-custom :loading="logLoading" :tableData="logTableData" :columns="logColumns" :height="tableHeight"></table-custom>
