<template>
	<div>
		<div class="tt-accsituation">
			<div class="tt-accsituation--operation">
				<div>
					<el-button type="primary" size="mini" @click="addMater">上传素材</el-button>
					<el-button type="primary" size="mini" :loading="refloading" @click="refresh">{{
						refloading ? '刷新中...' : '刷新'
					}}</el-button>
					<el-button type="danger" size="mini" :loading="delloading" @click="delMaters">{{
						refloading ? '删除中...' : '批量删除'
					}}</el-button>
				</div>
			</div>
    ...
    <!-- 新增素材弹层 -->
		<AddMaterDialog :showdialog.sync="showAddDialog"></AddMaterDialog>
		<!-- 编辑素材弹层 -->
		<EditMaterDialog :showdialog.sync="showEditDialog" :ruleForm.sync="editData"></EditMaterDialog>
	</div>
</template>
...
<script>
  ...
  import AddMaterDialog from './components/AddMaterDialog.vue';
	import EditMaterDialog from './components/EditMaterDialog.vue';
