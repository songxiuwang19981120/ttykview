<template>
	<div>
		<div class="tt-accsituation">
			<div class="tt-accsituation--operation">
				<div>
					<el-button type="primary" size="mini" @click="editPriv">私信编辑</el-button>
					<el-button type="primary" size="mini" :loading="refloading" @click="refresh">{{
						refloading ? '刷新中...' : '刷新'
					}}</el-button>
					<el-button type="danger" size="mini" :loading="delloading" @click="delPrivs">{{
						refloading ? '删除中...' : '批量删除'
					}}</el-button>
				</div>
			</div>
    ...
    <!-- 新增私信弹层 -->
		<AddPrivDialog :showdialog.sync="showAddDialog"></AddPrivDialog>
		<!-- 编辑私信弹层 -->
		<EditPrivDialog :showdialog.sync="showEditDialog" :ruleForm.sync="editData"></EditPrivDialog>
	</div>
</template>
...
<script>
  ...
  import AddPrivDialog from './components/AddPrivDialog.vue';
	import EditPrivDialog from './components/EditPrivDialog.vue';
