    ...
    >
      ...
      <el-form
        ...
        <el-form-item label="输入作品文案：">
          <el-input v-model="releaseVideoForm.work_text" style="width: 70%" placeholder="请输入文案"></el-input>
        </el-form-item>

        <el-form-item label="输入标签：">
          <el-input v-model="releaseVideoForm.tag" style="width: 70%" type="textarea" placeholder="请输入标签(可输入多个)"></el-input>
        </el-form-item>

        <el-form-item label="输入需要@的ID：">
          <el-input v-model="releaseVideoForm.id" style="width: 70%" type="textarea" placeholder="请输入需@ID(可输入多个)"></el-input>
        </el-form-item>

        <el-form-item label="输入任务名称：">
          <el-input v-model="releaseVideoForm.task_name" style="width: 70%" placeholder="请输入任务名称"></el-input>
        </el-form-item>
