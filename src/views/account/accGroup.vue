  ...
  <div>
    <div style="margin: 10px 0 20px 0">
      <el-button
        ...
        ><i class="el-icon-plus"></i>添加分组</el-button
      >
      <el-popconfirm
    ...
    >
      ...
      >
        <el-form-item label="分组名称:" prop="grouping_name">
          <el-input
            v-model="exitform.grouping_name"
            placeholder="请输入分组名称"
            style="width: 60%"
          ></el-input>
        </el-form-item>
        ...
        },
        {
          ...
          render: (h, { row }) => {
            return (
              <div>
                <span
                  style="color:#409EFF;cursor:pointer;margin-right:20px;margin-left:20px"
                  onClick={this.examine.bind(this, row)}
                >
                  编辑
                </span>
                <el-popconfirm
